...
theme.fg_normal                                 = "#CDD6F4"  -- Overlay0
theme.fg_focus                                  = "#89b4fa"  -- Blue
theme.bg_normal                                 = "#1E1E2E"  -- Base
theme.bg_focus                                  = "#1E1E2E"  -- Base
theme.fg_urgent                                 = "#F38BA8"  -- Red
theme.bg_urgent                                 = "#1E1E2E"  -- Base
theme.border_width                              = dpi(1)
theme.border_normal                             = "#585B70"  -- Surface1
theme.border_focus                              = "#89b4fa"  -- Blue
theme.taglist_fg_focus                          = "#F5E0DC"  -- Rosewater
theme.taglist_bg_focus                          = "#1E1E2E"  -- Base
theme.taglist_bg_normal                         = "#1E1E2E"  -- Base
theme.titlebar_bg_normal                        = "#313244"  -- Mantle
theme.titlebar_bg_focus                         = "#45475A"  -- Crust
